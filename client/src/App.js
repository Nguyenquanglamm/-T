  ...
  return (
    ...
    <Routes>
      <Route path="/admin" element={<BaseAdmin />}>
        ...
        <Route
          path="productDetails"
          element={<CreateProductDetai></CreateProductDetai>}
        ></Route>
        ...
        <Route
          path="updateproductadmin/:idSanPham"
          element={<UpdateProductAdmin></UpdateProductAdmin>}
        ></Route>
        <Route
          path="updateproductdetailsadmin/:idSanPham"
          element={<UpdateProductDetailsAdmin></UpdateProductDetailsAdmin>}
        ></Route>
        <Route
          path="warehousedetail/:idSanPham"
