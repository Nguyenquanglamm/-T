        ...
        <div className="mb-10 mt-2">
            <div className=" w-[1200px] m-auto ">
                ...
                Hình thức máy và hộp máy như mới<br/>
                    ...
                    Máy không có dấu hiệu tác động từ bên ngoài: Rơi, vỡ, móp méo, cong vênh, trầy xước, bị dung dịch hoá chất và chất lỏng xâm nhập vào.<br/>
...
Điều kiện bảo hành không áp dụng cho:<br/>

•  Hỏng hóc do gặp sơ xuất, lạm dụng, dùng sai cách, lũ lụt, hoả hoạn, động đất hoặc những nguyên nhân bên ngoài khác.<br/>

•  Hỏng hóc do tự ý can thiệp vào phần cứng của máy, tự ý tháo mở máy, tác động vào máy (trong đó có nâng cấp và mở rộng) bởi bất cứ cá nhân, đơn vị nào bên ngoài mà không thuộc uỷ quyền bảo hành của Hoàng Hà Mobile.<br/>

•  Hỏng hóc do máy bị rơi vỡ va đập, cong vênh, móp, méo, trầy, lõm và bị vỡ ở các cổng, số serial đã bị xoá mờ hoặc mất.<br/>

•  Máy bị ẩm mốc, cháy chập, bị dung dịch, hoá chất và các loại chất lỏng xâm nhập vào.<br/>

•  Số IMEl trên máy và phiếu bảo hành không trùng khớp với nhau.<br/>

•  Phiếu bảo hành tự ý sửa đổi hoặc gạch xoá, rách nát không nhìn rõ được số IMEl, không ghi rõ ngày mua hàng<br/>

•  Tem niêm phong bảo hành bị rách, vỡ, bị dán đè hoặc bị sửa đổi<br/>

•  Tiến hành những sửa đổi không được phép đối với phần mềm của nhà cung cấp như trường hợp sản phẩm bị can thiệp phần mềm hệ thống: Root, Unlock Bootloader, Jailbreak máy.<br/>

•  Tình trạng sóng, mạng kém không ổn định do chất lượng mạng điện thoại theo khu vực<br/>
