            ...
            <div className=" flex">
              ...
              <div className="wrap-details">
                <div className=" mb-5 text-2xl">
                  <Dongia item={dataPro && dataPro?.donGia[indexCap]}></Dongia>
                </div>
                ...
                <button
                  ...
                  onClick={() => {
                    handleAddtoCart({...dataPro,dungLuong:dataPro.dungLuong[indexCap],mausac:dataPro.mausac[indexColor]});
                  }}
                >
                  Thêm Vào Giỏ Hàng
                </button>
                <button
                  type="submit"
                  className="px-4 ml-2 py-2 font-semibold rounded-md  border border-black text-black  hover:bg-gray-300 transition-all"
                >
                  Mua Ngay
                </button>
              </div>
...
function Dongia({ item }) {
  return (
    <span className="py-2 px-4 border border-gray-200 rounded-lg">{item}</span>
  );
}
